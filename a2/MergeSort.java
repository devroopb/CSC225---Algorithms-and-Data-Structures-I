...
public class MergeSort{
	...
	*/
	public static ListNode MergeSort(ListNode head){
		...
		ListNode pivot = middle(head,head);
		ListNode L1 = head;
		ListNode L2 = pivot.next;
		pivot.next = null;
		head = merge(MergeSort(L1),MergeSort(L2));
		return head;
	}
	
	public static ListNode middle(ListNode temp, ListNode temp2){
		if(temp2.next == null || temp2.next.next == null){
			return temp;
		}else{
			return middle(temp.next, temp2.next.next);
		}	
	}
